...
<section class="landsdele-wrapper">
    ...
    <div class="landsdele-card landsdele-reveal">
        <div class="landsdele-content">
            ...
            <p>
                Nordjylland byder på alt fra gastronomiske oplevelser til enestående naturoplevelser i den rå og til tider barske nordjyske natur.
            </p>
    ...
    <div class="landsdele-card landsdele-reverse landsdele-reveal">
        <div class="landsdele-content">
            ...
            <p>
                Sjælland byder på fantastiske oplevelser for både store og små.
            </p>
    ...
    <div class="landsdele-card landsdele-reveal">
        <div class="landsdele-content">
            ...
            <p>
                På Fyn kan du opleve alt lige fra betagende naturoplevelser.
            </p>
    ...
    <div class="landsdele-card landsdele-reverse landsdele-reveal">
        <div class="landsdele-content">
            ...
            <p>
                Midtjylland byder på et væld af oplevelser for både store og små.
            </p>
    ...
    <div class="landsdele-card landsdele-reveal">
        <div class="landsdele-content">
            ...
            <p>
                Sydjylland byder på fantastisk natur og dramatisk historie.
            </p>
